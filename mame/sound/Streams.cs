...
namespace mame
{
    ...
    public partial class Sound
    {
        ...
        private static void generate_resampled_data_qsound()
        {
            int offset;
            long basetime;
            int basesample;
        ...
        private static void generate_resampled_data_ay8910(int gain)
        {
            int offset;
            int sample;
            long basetime;
            ...
            int gain1;
            int sampindex;
            gain1 = (gain * AY8910.AA8910[0].stream.gain) >> 8;
            basetime = mixerstream.output_sampindex * mixerstream.attoseconds_per_sample - mixerstream.attoseconds_per_sample;
            if (basetime >= 0)
            ...
            if (step > 0x400000)
            {
                ...
                for (sampindex = 0; sampindex < 0x3c0; sampindex++)
                {
                    ...
                    sample /= smallstep;
                    mixerstream.streaminput[0][sampindex] = (sample * gain1) >> 8;
                    basefrac += step;
                    offset += (int)(basefrac >> 22);
                    basefrac &= 0x3fffff;
                }
        ...
        private static void generate_resampled_data_ay8910_3(int chip, int gain, int start)
        {
            int offset;
        ...
        private static void generate_resampled_data_ym2203(int c, int gain, int minput)
        {
            int offset;
            long basetime;
            int basesample;
        ...
        private static void generate_resampled_data_ym3526(int gain, int minput)
        {
            int offset;
            long basetime;
            int basesample;
        ...
        private static void generate_resampled_data_ym2610()
        {
            int offset;
            int sample0, sample1;
            long basetime;
        ...
        private static void generate_resampled_data_namcos1()
        {
            int offset;
            int sample0, sample1;
            long basetime;
        ...
        private static void generate_resampled_data_dac(int gain, int minput)
        {
            int offset;
            int sample;
            long basetime;
        ...
        private static void generate_resampled_data_ym2413(int gain, int minput)
        {
            int offset;
            int sample0, sample1;
            long basetime;
        ...
        private static void generate_resampled_data_ym3812(int gain, int minput)
        {
            int offset;
            int sample;
            long basetime;
        ...
        private static void generate_resampled_data_ics2115(int gain)
        {
            int offset;
            long basetime;
            int basesample;
        ...
        public static void generate_resampled_data_iremga20(int gain)
        {
            int offset;
            int sample0, sample1;
            long basetime;
        ...
        public static void generate_resampled_data_k053260(int gain, int minput1, int minput2)
        {
            int offset;
            int sample0, sample1;
            long basetime;
        ...
        public static void generate_resampled_data_k007232(int gain)
        {
            int offset;
            long basetime;
            int basesample;
        ...
        public static void generate_resampled_data_upd7759(int gain)
        {
            int offset;
            int sample;
            long basetime;
        ...
        public static void generate_resampled_data_sample(int gain, int minput)
        {
            int offset;
            long basetime;
            int basesample;
        ...
        public static void generate_resampled_data_msm5205_0(int gain, int minput)
        {
            int offset;
            int sample;
            long basetime;
        ...
        public static void generate_resampled_data_msm5205_1(int gain, int minput)
        {
            int offset;
            int sample;
            long basetime;
        ...
        public static void generate_resampled_data_sn76496(int chip, int gain, int minput)
        {
            int offset;
            int sample;
            long basetime;
            ...
            basetime = mixerstream.output_sampindex * mixerstream.attoseconds_per_sample - mixerstream.attoseconds_per_sample;
            if (basetime >= 0)
                basesample = (int)(basetime / SN76496.ss1[chip].Channel.attoseconds_per_sample);
            else
                basesample = (int)(-(-basetime / SN76496.ss1[chip].Channel.attoseconds_per_sample) - 1);
            offset = basesample - SN76496.ss1[chip].Channel.output_base_sampindex;
            basefrac = (uint)((basetime - basesample * SN76496.ss1[chip].Channel.attoseconds_per_sample) / (Attotime.ATTOSECONDS_PER_SECOND >> 22));
            step = (uint)(((ulong)SN76496.ss1[chip].Channel.sample_rate << 22) / 48000);
            if (step > 0x400000)
            {
                int smallstep = (int)(step >> 14);
                for (sampindex = 0; sampindex < 0x3c0; sampindex++)
                {
                    ...
                    int scale;
                    scale = (int)((0x400000 - basefrac) >> 14);
                    sample = SN76496.ss1[chip].Channel.streamoutput[0][offset + tpos] * scale;
                    tpos++;
                    remainder -= scale;
                    while (remainder > 0x100)
                    {
                        sample += SN76496.ss1[chip].Channel.streamoutput[0][offset + tpos] * 0x100;
                        tpos++;
                        remainder -= 0x100;
                    }
                    sample += SN76496.ss1[chip].Channel.streamoutput[0][offset + tpos] * remainder;
                    sample /= smallstep;
                    mixerstream.streaminput[minput][sampindex] = (sample * gain) >> 8;
                    basefrac += step;
                    offset += (int)(basefrac >> 22);
        ...
        public static void streams_update_cps1()
        {
        ...
        private static void streams_update_qsound()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
        ...
        private static void streams_update_dataeast_pcktgal()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
        ...
        private static void streams_update_tehkan()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
        ...
        private static void streams_update_neogeo()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
        ...
        private static void streams_update_technos_ddragon()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
        ...
        private static void streams_update_seibu_kncljoe()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
            ...
            AY8910.AA8910[0].stream.adjuststream(second_tick);
            SN76496.ss1[0].Channel.adjuststream(second_tick);
            SN76496.ss1[1].Channel.adjuststream(second_tick);
            mixerstream.adjuststream(second_tick);
            last_update_second = curtime.seconds;
            AY8910.AA8910[0].stream.updatesamplerate();
        }
        ...
        private static void streams_update_namcos1()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
        ...
        private static void streams_update_igs011_drgnwrld()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
        ...
        private static void streams_update_igs011_lhb()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
        ...
        private static void streams_update_igs011_lhb2()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
        ...
        private static void streams_update_igs011_vbowl()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
        ...
        private static void streams_update_pgm()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
        ...
        private static void streams_update_m72()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
        ...
        private static void streams_update_m92()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
        ...
        private static void streams_update_taito_tokio()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
        ...
        private static void streams_update_taito_bublbobl()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
        ...
        private static void streams_update_taito_kageki()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
        ...
        private static void streams_update_taito_kabukiz()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
        ...
        private static void streams_update_konami_cuebrick()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
        ...
        private static void streams_update_konami_mia()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
        ...
        private static void streams_update_konami_tmnt()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
        ...
        private static void streams_update_konami_glfgreat()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
        ...
        private static void streams_update_konami_ssriders()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
        ...
        private static void streams_update_konami_prmrsocr()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
        ...
        private static void streams_update_capcom_gng()
        {
            Atime curtime = Timer.global_basetime;
            bool second_tick = false;
            if (curtime.seconds != last_update_second)
