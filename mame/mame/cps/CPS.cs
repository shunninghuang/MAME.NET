    ...
    public partial class CPS
    {
        ...
        public static void cps2_interrupt()
        {
            ...
            if (cps1_scanline1 == scancount || (cps1_scanline1 < scancount && (cps1_scancalls != 0)))
            {
                ...
                Video.video_screen_update_partial(16 - 10 + scancount);
                cps1_scancalls++;
            }
            if (cps1_scanline2 == scancount || (cps1_scanline2 < scancount && cps1_scancalls == 0))
            {
                cps_b_regs[0x12 / 2] = 0;
                Cpuint.cpunum_set_input_line(0, 4, LineState.HOLD_LINE);
                cps2_set_sprite_priorities();
            ...
            if (scancount == 256)  /* VBlank */
            {
                ...
                {
                    cps2_set_sprite_priorities();
                    Video.video_screen_update_partial(256);
                }
                cps2_objram_latch();
            }
        }
