...
namespace mame
{
    public partial class CPS
    {
        ...
        public static void driver_init_cps2_video()
        {
            cps1_scanline1 = 262;
            cps1_scanline2 = 262;
            cps1_scancalls = 0;
        ...
        private static void cps1_render_layer(RECT cliprect, int layer, byte primask)
        {
            switch (layer)
            {
                case 0:
                    ...
                    break;
                case 1:
                    ttmap[0].tilemap_draw_primask(cliprect, 0x20, primask);
                    break;
                case 2:
                    ttmap[1].tilemap_draw_primask(cliprect, 0x20, primask);
                    break;
                case 3:
                    ttmap[2].tilemap_draw_primask(cliprect, 0x20, primask);
                    break;
            }
        }
        ...
        public static void video_update_cps1()
        {
            ...
            cps1_render_layer(Video.screenstate.visarea, l0, 0);
            if (l1 == 0)
            {
                cps1_render_high_layer(l0);
            }
            cps1_render_layer(Video.screenstate.visarea, l1, 0);
            if (l2 == 0)
            {
                cps1_render_high_layer(l1);
            }
            cps1_render_layer(Video.screenstate.visarea, l2, 0);
            if (l3 == 0)
            {
                cps1_render_high_layer(l2);
            }
            cps1_render_layer(Video.screenstate.visarea, l3, 0);
        }
        public static void video_update_cps2()
        {
            int i;
            int l0, l1, l2, l3;
            int videocontrol = cps_a_regs[CPS1_VIDEOCONTROL];
