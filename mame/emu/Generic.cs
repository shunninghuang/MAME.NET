...
namespace mame
{
    public class Generic
    {
        ...
        public static void paletteram_xxxxBBBBGGGGRRRR_split1_w(int offset, byte data)
        {
            paletteram[offset] = data;
            set_color_444(offset, 0, 4, 8, paletteram16_split(offset));
        }
        public static void paletteram_xxxxBBBBGGGGRRRR_split2_w(int offset, byte data)
        {
        ...
        public static void paletteram_xBBBBBGGGGGRRRRR_le_w(int offset, byte data)
        {
            paletteram[offset] = data;
            set_color_555(offset / 2, 0, 5, 10, paletteram16_le(offset));
        }
        public static void paletteram_xBBBBBGGGGGRRRRR_be_w(int offset, byte data)
        {
            paletteram[offset] = data;
        ...
        public static void paletteram_xRRRRRGGGGGBBBBB_le_w(int offset, byte data)
        {
            paletteram[offset] = data;
