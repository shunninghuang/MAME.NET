...
namespace mame
{
    ...
    partial class Video
    {
        ...
        public static void video_init()
        {
            ...
            switch (Machine.sBoard)
            {
                ...
                case "Neo Geo":
                    ...
                    break;
                case "Technos":
                    screenstate.width = 0x180;
                    screenstate.height = 0x110;
                    screenstate.visarea.min_x = 0;
                    screenstate.visarea.max_x = 0xff;
                    screenstate.visarea.min_y = 0;
                    screenstate.visarea.max_y = 0xef;
                ...
                case "Seibu":
                    screenstate.width = 0x100;
                    screenstate.height = 0x100;
                    screenstate.visarea.min_x = 8;
                    screenstate.visarea.max_x = 0xf7;
                    screenstate.visarea.min_y = 0;
                    screenstate.visarea.max_y = 0xff;
                    fullwidth = 0x100;
                    fullheight = 0x100;
                    frame_update_time = new Atime(0, (long)(1e18 / 60));
                    screenstate.vblank_period = (long)(1e12 * 1500);
                    ...
                    video_update_callback = Seibu.video_update_kncljoe;
                    video_eof_callback = Technos.video_eof_ddragon;
                    break;
                case "Tad":
                    screenstate.width = 0x100;
                ...
                case "Konami":
                    ...
                    bbmp = new Bitmap[1];
                    bbmp[0] = new Bitmap(288, 224);
                    video_eof_callback = Konami.video_eof;
                    switch (Machine.sName)
                    {
                        case "scontra":
                        case "scontraa":
                        ...
                        case "cuebrick":
                            ...
                            screenstate.visarea.max_y = 0xef;
                            screenstate.vblank_period = (long)(1e12 * 2500);
                            video_update_callback = Konami.video_update_mia;
                            break;
                        case "mia":
                        case "mia2":
                            screenstate.width = 0x200;
                        ...
                        case "punkshot2a":
                            ...
                            screenstate.visarea.max_y = 0xef;
                            screenstate.vblank_period = (long)(1e12 * 2500);
                            video_update_callback = Konami.video_update_punkshot;
                            break;
                        case "lgtnfght":
                        case "lgtnfghta":
                        case "lgtnfghtu":
                        case "trigon":
                            ...
                            screenstate.visarea.max_y = 0xef;
                            screenstate.vblank_period = (long)(1e12 * 2500);
                            video_update_callback = Konami.video_update_lgtnfght;
                            break;
                        case "blswhstl":
                        case "blswhstla":
                        case "detatwin":
                            ...
                            screenstate.vblank_period = (long)(1e12 * 2500);
                            video_update_callback = Konami.video_update_lgtnfght;
                            video_eof_callback = Konami.video_eof_blswhstl;
                            break;
                        case "glfgreat":
                        case "glfgreatj":
                        case "prmrsocr":
                        case "prmrsocrj":
                            ...
                            screenstate.visarea.max_y = 0xef;
                            screenstate.vblank_period = (long)(1e12 * 2500);
                            video_update_callback = Konami.video_update_glfgreat;
                            break;
                        case "tmnt2":
                        case "tmnt2a":
                        case "tmnt2o":
                        ...
                        case "qgakumon":
                            ...
                            screenstate.visarea.max_y = 0xef;
                            screenstate.vblank_period = (long)(1e12 * 2500);
                            video_update_callback = Konami.video_update_tmnt2;
                            break;
                        case "ssriders":
                        case "ssriderseaa":
                        case "ssridersebd":
        ...
        public static void video_screen_configure(int width, int height, RECT visarea, long frame_period)
        {
            ...
            {
                Timer.timer_adjust_periodic(scanline0_timer, Attotime.ATTOTIME_ZERO, Attotime.ATTOTIME_NEVER);
            }
            else
            {
        ...
        public static bool video_screen_update_partial(int scanline)
        {
            ...
            bool result = false;
            if (scanline < screenstate.last_partial_scan)
            {
                return result;
            }
